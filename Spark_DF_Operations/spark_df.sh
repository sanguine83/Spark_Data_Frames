...
echo "spark-submit --deploy-mode cluster --class RDD_Operations.Driver ${JAR_FILE_PATH}/Spark_DF_Operations.jar 100" >> ${LOG_PATH}/log_${DT}
spark-submit --deploy-mode cluster --master yarn --class RDD_DF.Driver ${JAR_FILE_PATH}/Spark_DF_Operations.jar 100
echo "###############################################################################" >> ${LOG_PATH}/log_${DT}
